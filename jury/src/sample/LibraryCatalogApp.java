...
public class LibraryCatalogApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        toolBar.getItems().addAll(new Label("Search:"), searchField, addBtn, refreshChartBtn);
    ...
    private TableColumn<Book, String> createColumn(String title, 
        Function<Book, StringProperty> prop, int width) {
